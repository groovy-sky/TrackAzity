...
az deployment group create --resource-group $container_name --template-file Container.json --parameters topicName=$topic_name storageAccountName=$storage_account_name 